...
void Protocentral_ADS1220::set_OperationMode(int OPmode)    // added DR
{
...
void Protocentral_ADS1220::TemperatureSensorMode_disable(void)    // added DR
{
    m_config_reg1 &= ~_BV(1);
    writeRegister(CONFIG_REG1_ADDRESS,m_config_reg1);
}

void Protocentral_ADS1220::TemperatureSensorMode_enable(void)   // added DR
{
    m_config_reg1 |= _BV(1);
    writeRegister(CONFIG_REG1_ADDRESS,m_config_reg1);
}

void Protocentral_ADS1220::CurrentSources_OFF(void)   // added DR
{
    m_config_reg1 &= ~_BV(0);
    writeRegister(CONFIG_REG1_ADDRESS,m_config_reg1);
}

void Protocentral_ADS1220::CurrentSources_ON(void)   // added DR
{
    m_config_reg1 |= _BV(0);
    writeRegister(CONFIG_REG1_ADDRESS,m_config_reg1);
}
...
void Protocentral_ADS1220::set_FIR_Filter(int filter)    // added DR
{
...
void Protocentral_ADS1220::LowSideSwitch_OPEN(void)   // added DR
{
    m_config_reg2 &= ~_BV(3);
    writeRegister(CONFIG_REG2_ADDRESS,m_config_reg2);
}

void Protocentral_ADS1220::LowSideSwitch_CLOSED(void)   // added DR
{
    m_config_reg2 |= _BV(3);
    writeRegister(CONFIG_REG2_ADDRESS,m_config_reg2);
}

void Protocentral_ADS1220::set_IDAC_Current(int IDACcurrent)    // added DR
{
...
void Protocentral_ADS1220::set_IDAC2_Route(int IDAC2routing)    // added DR
{
 ...
 void Protocentral_ADS1220::DRDYmode_default(void)   // added DR
 {
     m_config_reg3 &= ~_BV(3);
     writeRegister(CONFIG_REG3_ADDRESS,m_config_reg3);
 }

 void Protocentral_ADS1220::DRDYmode_DOUT(void)   // added DR
 {
     m_config_reg3 |= _BV(3);
     writeRegister(CONFIG_REG3_ADDRESS,m_config_reg3);
 }
